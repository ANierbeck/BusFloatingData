...
self.getWebsocket = function(bbox) {
    var path = "ws://localhost:8000/vehicles/boundingBox?bbox=";
    path += bbox;
...
//  var socket = self.getWebsocket(tlLonLat[1]+","+tlLonLat[0]+","+brLonLat[1]+","+brLonLat[0]);
//
