...
docker run -it zutherb/mesos-killrweather-app ./ingest.sh -Dcassandra.connection.host=$CASSANDRA_IP -Dkafka.hosts.0=$KAFKA_IP:1025 -Dkafka.zookeeper.connection=$ZOOKEEPER_IP